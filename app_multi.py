...
--------------------------------------
Streamlit + papermill web interface for keyence_cellpose_notebook_multi_conditions.ipynb.
...
NOTEBOOK_PATH = os.path.join(os.path.dirname(__file__), "keyence_cellpose_notebook_multi_conditions.ipynb")
EXECUTED_NB_NAME = "keyence_cellpose_notebook_multi_executed.ipynb"
